...
public class EditUserMVCActionCommand extends BaseMVCActionCommand {
	...
	protected User addUser(ActionRequest actionRequest) throws Exception {
		...
		PermissionChecker checker  =PermissionCheckerFactoryUtil.create(UserLocalServiceUtil.getDefaultUser(themeDisplay.getCompanyId()));
	...
	protected Object[] updateUser(
		...
		if (user.getUserId() == themeDisplay.getUserId()) {
			...
			session.removeAttribute("org.apache.struts.action.LOCAL");
