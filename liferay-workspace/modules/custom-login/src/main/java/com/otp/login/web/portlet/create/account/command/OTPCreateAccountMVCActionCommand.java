...
public class OTPCreateAccountMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void addUser(
		...
		//Group globalGroup = user.getGroupId();
		PermissionChecker checker  =PermissionCheckerFactoryUtil.create(UserLocalServiceUtil.getDefaultUser(company.getCompanyId()));
		PermissionThreadLocal.setPermissionChecker(checker);
		System.out.println("Secret Key--> "+ParamUtil.getString(actionRequest, "secretKey"));
		
		user.getExpandoBridge().setAttribute("Secret Key", ParamUtil.getString(actionRequest, "secretKey"));
	...
	protected void doProcessAction(
		...
		//System.out.println("My custom login action cmd called. secretKey-->"+ParamUtil.getString(actionRequest, "secretKey"));
	...
	public PortletURL getLoginURL(HttpServletRequest request, long plid)
			throws PortletModeException, WindowStateException {

			PortletURL portletURL = PortletURLFactoryUtil.create(
				request, "com_liferay_login_web_portlet_LoginPortlet", plid, 
